...
**Explanation:**
This advanced example implements attention scoring by having the model assess chunk relevance, then reorders chunks so the most relevant appear at both the beginning (primacy) and end (recency) of the context. 
This ensures maximum attention to important information.
